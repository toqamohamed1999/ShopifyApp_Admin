package eg.gov.iti.jets.shopifyapp_admin.creatediscount.presentation.viewmodel
...
class CreateDiscountViewModel(private val repo: CreateDiscountRepo) : ViewModel() {
...
class CreateDiscountViewModelFactory(private val repo: CreateDiscountRepo) : ViewModelProvider.Factory {
